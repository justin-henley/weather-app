...
export const displayApiError = (statusCode) => {
  ...
  console.error(properMessage, statusCode);
};
...
const updateWeatherLocationHeader = (message) => {
  ...
  // If its a coordinate position, trim some decimals
...
export const updateDisplay = (weatherJson, locationObj) => {
  // hide weather
  fadeDisplay();
  // delete contents of current forecast conditions and daily forecast
  clearDisplay();
  ...
  // Announce weather to screen reader
  ...
  updateWeatherLocationHeader(locationObj.name);

  // Current conditions
  const ccArray = createCurrentConditionsDivs(weatherJson, locationObj.unit);
  displayCurrentConditions(ccArray);

  // Six Day Forecast
  displaySixDayForecast(weatherJson);

  // Set focus back on search area
  setFocusOnSearch();

  // fade weather back in
  fadeDisplay();
};
...
const fadeDisplay = () => {
  ...
  const sixDay = document.getElementById("currentForecast");
